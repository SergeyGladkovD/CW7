...
class Habit(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name="владелец", **NULLABLE)
    ...
    reward = models.CharField(max_length=150, verbose_name="Награда за выполнение", **NULLABLE)
    duration = models.DurationField(verbose_name="Продолжительность выполнения", default=timedelta(minutes=2))
